        ...
        return (
            <div className="home-section work-container">
                <div className="labels-work">
                    <LabelsContainer labels={labels} activeLabels={activeLabels} onLabelClick={this.onLabelClick}
                                     clearSelectedLabels={this.clearSelectedLabels}/>
                </div>
                <div className="project-container-work">
                    <ProjectsContainer projects={projects} activeLabels={activeLabels}
                                       projectClick={this.onProjectClick}/>
                </div>
            </div>
        );
    }
